...
//        Quarto board = new Quarto("Unknown","Unknown 2");
//        System.out.println(Arrays.deepToString(board.getBoard()));
//        System.out.println(board.getBoard()[1][3] == null);
//
        int index = 0;
        fig.returnRemovedFigure(0);
//        board.addFigureToBoard(0,1,fig.returnRemovedFigure(1));
//        board.addFigureToBoard(0,2,fig.returnRemovedFigure(2));
//        board.addFigureToBoard(0,3,fig.returnRemovedFigure(12));


  //      System.out.println(board);
        fig.printAvailableFigures();
